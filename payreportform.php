...
PRINT PAYMENT REPORT SHEETS<br />
<h5>FILTER PAYMENTS BY CATEGORIES </h5>
</div>
<div class="panel-body">
<form action="paystatement.php" method="post" enctype="multipart/form-data" name="Activities Generator" target="_blank">
<table align="center" cellspacing="4" class="table table-bordered">
            ...
            <tr>
              <td colspan="4" class="labels"><h4>CATEGORIES 
                ...
                <hr /> 
                <?php $getsubcat = mysql_query("SELECT DISTINCT credit FROM payments") or die(mysql_error());
		while($subcat = mysql_fetch_array($getsubcat)){?>
                <input type="checkbox" name="subcategory[]" value="<?php echo $subcat['credit']; ?>"> <?php echo $subcat['credit']; ?></br>
        <?php } ?></td>
             </tr>
            <tr>
