...
$highestcert=validateData($_POST['highestcert']."/".$_POST['school']."(".$_POST['year'].")");
$picture=$_FILES['picture']['name'];
$cv=$_FILES['cv']['name'];
$guarantor=validateData($_POST['guarantor']."/".$_POST['gphoneno']).", ".validateData($_POST['guarantor2']."/".$_POST['gphoneno2']);
...
$staffid = strtoupper("KS".substr(number_format(time() * rand(),0,'',''),0,8));
...
$picture = $filename = str_replace(' ', '_', $filename);
$cv = $filename2 = str_replace(' ', '_', $filename2);
...
<input name="firstname" type="text" class="form-control" id="firstname" maxlength="50" placeholder="Firstname">
</div>
<div class="col-lg-4">
<label class="control-label col-lg-12" for="content">Surname: </label>
<input name="surname" type="text" class="form-control" placeholder="Surname" maxlength="50">
</div>
<div class="col-lg-4">
<label class="control-label col-lg-12" for="content">Othernames: </label>
<input name="othernames" type="text" class="form-control" placeholder="othernames" maxlength="50">
</div>
</div>
...
<input name="dob" type="text" class="form-control" placeholder="Date of Birth" maxlength="50" id="datepicker">
</div>
<div class="col-lg-4">
<label class="control-label col-lg-12" for="content">State of Origin:</label>
<input name="stateoforigin" list="state" class="form-control" id="state" maxlength="50" placeholder="State of Origin">
<datalist id="state">
<option value="Abia">
...
<input name="phoneno" type="text" class="form-control" placeholder="Phone Number" maxlength="50">
</div>
<div class="col-lg-6">
<label class="control-label col-lg-12" for="content">E-mail:</label>
<input name="email" type="email" class="form-control" id="titLe" maxlength="100" placeholder="E-mail">
</div>
</div>
...
<input name="address" type="text" class="form-control" placeholder="Address" maxlength="100">
</div>
</div>

<div class="form-group">
<div class="col-lg-6">
<label class="control-label col-lg-12" for="content">Guarantor's Name(1): </label>
<input name="guarantor" type="text" class="form-control" placeholder="Guarantor Name" maxlength="50">
</div>
<div class="col-lg-6">
...
<input name="highestcert" list="cert" class="form-control" placeholder="Highest Certificate" maxlength="50">
<datalist id="cert">
...
<input name="empdate" type="text" class="form-control" placeholder="Date Employed" id="datepicker2" maxlength="50">
</div>
<div class="col-lg-3">
...
<input name="salary" type="text" class="form-control" placeholder="salary" maxlength="30">
</div>
</div> 
...
<input name="spassword" type="text" class="form-control" placeholder="Password" maxlength="50">
</div>
</div> 
...
<div class="col-lg-6">
<label class="control-label col-lg-12" for="content">.</label>
<input name="save1" type="submit" value="Save Personnel Record" class="btn btn-lg btn-primary btn-block" />
</div>
</div>
</form>
