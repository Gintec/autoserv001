...
<input name="dob" type="text" class="form-control" placeholder="Date of Birth" disabled="disabled" maxlength="50" id="datepicker" value="<?php echo $rg['dob']; ?>">
</div>
<div class="col-lg-4">
...
<input name="guarantor" type="text" class="form-control"  disabled="disabled" placeholder="Guarantor Name" maxlength="50" value="<?php echo $rg['guarantor']; ?>">
</div>
<div class="col-lg-6">
<label class="control-label col-lg-12" for="content">Guarantors Phone Number:</label>
<input name="gphoneno" type="text" class="form-control" maxlength="100" placeholder="Guarantor Phone Numer"  disabled="disabled">
</div>
</div>
...
<input name="highestcert" list="cert" class="form-control" placeholder="Highest Certificate"  disabled="disabled" maxlength="50" value="<?php echo $rg['highestcert']; ?>">
<datalist id="cert">
...
<input name="empdate" type="text" class="form-control"  disabled="disabled" placeholder="Date Employed" id="datepicker2" maxlength="50" value="<?php echo $rg['empdate']; ?>">
</div>
<div class="col-lg-3">
...
<input name="salary" type="text" class="form-control" placeholder="salary" maxlength="30" value="<?php echo $rg['salary']; ?>" disabled="disabled">
</div>
</div> 
