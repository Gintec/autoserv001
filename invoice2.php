...
<body onLoad="window.print()">
	...
	<div align="left" class="h3" style="margin-left:5%; margin-right:5%;">INVOICE <strong style="float:right; font-size:13px;">Date: <?php echo mysql_result(mysql_query("SELECT dated FROM jobs WHERE jobno='$jobno' LIMIT 1"),0); ?></strong></div>
...
<?php  $ji = mysql_query("SELECT vregno,chasisno,modelname,vin FROM vehicles WHERE vregno='$remarks'") or die(mysql_error()); while($j = mysql_fetch_row($ji)){$detail = "Reg No: <strong>".$j[0]."</strong><br /> Chasis No: <strong>".$j[1]."</strong><br />Make: <strong>".$j[2]."</strong>"; ?>
  <tr>
