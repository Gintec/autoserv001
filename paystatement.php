...
<h3 align="center">PAYMENT REPORT SHEET<hr />
...
$getrg = mysql_query("SELECT * FROM payments WHERE credit='$salesdesc' AND dated BETWEEN '$from' AND '$to' ORDER BY dated DESC") or die(mysql_error());
$tamount = 0;
...
<tr><td colspan="7" class="h3" align="right">Total Paid</td><td><?php echo "<h4>".number_format($totalpaid,2)."</h4>"; ?> </td></tr>
</tbody>
</table>
<?php   } ?>
